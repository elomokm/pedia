...
- **12 minutes** pour reconstruire ces 3–6 mois de mémoire parentale dans la consultation.
- Parents : oublient, ne trouvent pas les mots cliniques, parfois non-francophones.
- Pediatres : anamnèse refaite à chaque visite, signaux faibles invisibles à l'œil nu, zéro traçabilité longitudinale.
...
|---|---|---|---|
| Pediatres libéraux (FR) | 10 000 | 588 €/an (49 €/mo) | **5,9 M€** |
...
### 6.2 Pediatre libéral — **49 € / mois / praticien**
...
### An 1 — libéral pur
- **AFPA** (Association Française de Pediatrie Ambulatoire) partenariat de distribution.
- **Congrès pédiatriques** (JFRP, Printemps de la Pediatrie) — stand + ateliers chronométrés.
...
| | An 1 | An 2 | An 3 |
|---|---|---|---|
| **Pediatres libéraux actifs** | 500 | 1 500 | 3 500 |
...
*Dernière mise à jour : 2026-04-18 — avant pitch Cosmic Harp 2026, piste Pediatrie.*
