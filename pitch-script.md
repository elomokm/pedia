# Pedia — pitch script (3 minutes)

> ANDCS × MIT Hackathon 2026 · Track 2 — AI in Pediatrics
> 3 min pitch + 2 min Q&A · slides only · English
> Reading time at pitch cadence: ~3:00 · ~340 words
...
- The first ten words must come out without thinking — rehearse until automatic.
- Time each block. If "Hook" takes more than 25 s, you are running over.
- Half-second pause after each key figure: **180 days · 4 years · ROI ×21 · under 6 months**. Let them land.
- Direct eye contact on the ROI numbers — never read from notes there.
- The cascading close ("two euros a day · parents pay zero · children gain years") is the signature line. Land it, silence, "Thank you."

## Sources displayed on slides
